$(document).ready(function () {
  ...
  //// SEACH-TOP
  $('.seach__mobi').click(function () {
    $('#seach__top').toggleClass("active")
  })
  /// SHOW OPEN
  ...
  $(".appendix__toggle").click(function () {
    $('.fas.fa-list-ol').toggleClass('fa-angle-up')
    $(".appendix__nav").toggleClass('active')
    $(".productDetails__appendix").toggleClass('active')
  })
